...
describe('TrackList', () => {
  it('renders a TrackRow for each track', () => {
    ...
    render(<TrackList tracks={tracks} onToggleMute={vi.fn()} onSetVolume={vi.fn()} />)
  ...
  it('renders EmptyState when tracks is empty', () => {
    render(<TrackList tracks={[]} onToggleMute={vi.fn()} onSetVolume={vi.fn()} />)
  ...
  it('passes correct callbacks to TrackRow', () => {
    ...
    render(<TrackList tracks={tracks} onToggleMute={onToggleMute} onSetVolume={onSetVolume} />)
